...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('main_booksubclassification', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'BookClassification.name'
        db.alter_column('main_bookclassification', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
